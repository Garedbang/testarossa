...
export default class Header extends React.Component {
  ...
  render() {
    ...
    const {api, favoritesList, removeFromFavorites, handleFixContent} = this.props;
    return (
      <header className='container'>
        ...
        {isSearchClosed &&(
          <div className='favorite'>
            ...
            favoritesList={favoritesList}
            removeFromFavorites={removeFromFavorites}
            handleMovieIdCallback={this.props.handleMovieIdCallback}
            toggleFavoriteList={this.props.toggleFavoriteList}
            showFavoriteList={this.props.showFavoriteList}
            handleFixContent={handleFixContent} />
          </div>)}
      </header>
    )
